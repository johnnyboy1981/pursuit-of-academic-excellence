  ...
  return (
    ...
    <section className="relative flex w-full">
      ...
      <div className="hidden md:block md:w-1/2">
        <GatsbyImage className="top-0 right-0 -z-50 sticky h-screen" style={{ position: "sticky" }} objectFit="cover" objectPosition="left" image={pageData.aboutMeSideImage.gatsbyImageData} alt=""/>
      </div>
